...
class RB(Simulator):
    """
        RB (Round Robin) class is a simulator that implements the Round Robin scheduling algorithm.
        ...
        Methods:
        - __init__: Initializes the RB simulator with the provided parameters.
        - run: Executes the simulation loop for the Round Robin scheduling algorithm, updating the UI and handling process states.
"""
...
#     fcfs_scheduler = RB("small.dat", 2, 2, 2, "RB")
#     fcfs_scheduler.run()
